...
<dataIndex battleScribeVersion='2.03' name='T9A-slim' indexUrl='https://github.com/BSData/the-9th-age-essence-of-war/blob/main/cat/index.bsi?raw=true' xmlns='http://www.battlescribe.net/schema/dataIndexSchema'>
  <repositoryUrls />
